...
<body>
    ...
    <div id="Alta" class="form-1">
        <h2 class="form-titulo" style="text-align: center; color: aqua;">ALTA DE EMPLEADOS</h2>
        <div class="container">
            <form id="Alta" data-toggle="validator" data-focus="false" action="SvEmpleado" method="POST">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="apellido" name="apellido" required>
                            <label class="label-control" for="lphone">Apellido</label>
                            
                        </div>
                        <div class="form-group">
                            <input type="date" class="form-control-input" id="fechaNacim" name="fechaNacim" required>
                            <label class="label-control" for="fechaNacim">Fecha Nacimiento</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="dni" name="dni" required>
                            <label class="label-control" for="dni">Documento de Identidad</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="String" class="form-control-input" id="cargo" name="cargo" required>
                            <label class="label-control" for="cargo">Cargo</label>
                            <div class="help-block with-errors"></div>
                        </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="nacionaliad" name="nacionalidad" required>
                        ...
                        <div class="form-group">
                            <input type="tel" class="form-control-input" id="celular" name="celular" required>
                            <label class="label-control" for="celular">Teléfono</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                            <input type="String" class="form-control-input" id="sueldo" name="sueldo" required>
                            <label class="label-control" for="sueldo">Sueldo</label>
                            <div class="help-block with-errors"></div>
                        </div>
                ...
                <h2 class="form-titulo" style="text-align: center; color: aqua;">ALTA DE USUARIO</h2>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <input type="text" class="form-control-input" id="usuario" name="usuario" required>
                            <label class="label-control" for="usuario">Nombre de Usuario</label>
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
